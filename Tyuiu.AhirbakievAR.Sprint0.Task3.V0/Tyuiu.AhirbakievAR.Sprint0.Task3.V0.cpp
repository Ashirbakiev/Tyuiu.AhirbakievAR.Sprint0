// Tyuiu.AhirbakievAR.Sprint0.Task3.V0.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    std::cout << "Result = " << date->SummV3(10, 11, 5);
    std::cout << std::endl;
}
